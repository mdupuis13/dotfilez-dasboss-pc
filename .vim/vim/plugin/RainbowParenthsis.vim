...
hi level2c ctermfg=Darkblue guifg=Darkblue
hi level3c ctermfg=darkgray guifg=darkgray
hi level4c ctermfg=darkgreen guifg=darkgreen
hi level5c ctermfg=darkcyan guifg=darkcyan
hi level6c ctermfg=darkred guifg=darkred
hi level7c ctermfg=darkmagenta guifg=darkmagenta
hi level8c ctermfg=brown guifg=brown
hi level9c ctermfg=gray guifg=gray
...
hi level16c ctermfg=red guifg=lightblue
